                    ...
                    <div class="col">
                        <div class="card shadow mb-4">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h6 class="text-primary fw-bold m-0">Evolution chiffre d'affaire <%= annee %></h6>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <a class="btn btn-primary" href="/graphe/<%= annee-1 %>" style="border-style: none;background: rgb(242,242,242);color: rgb(0,0,0);"><svg xmlns="http://www.w3.org/2000/svg" viewBox="-32 0 512 512" width="1em" height="1em" fill="currentColor">
                                <!--! Font Awesome Free 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. -->
                            ...
                            </svg></a><span style="margin-left: 10px;margin-right: 10px;color: rgb(0,0,0);"><%= annee %></span>
                                <a class="btn btn-primary" href="/graphe/<%= annee+1 %>" style="border-style: none;color: rgb(0,0,0);background: rgb(242,242,242);"><svg xmlns="http://www.w3.org/2000/svg" viewBox="-32 0 512 512" width="1em" height="1em" fill="currentColor">
                                <!--! Font Awesome Free 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. -->
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <th style="color: rgb(0,0,0);">Nombre total d'inscrits</th>
                                        </tr>
                                        </thead>
                                        <tbody>
